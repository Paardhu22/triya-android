/**
 * Money helpers. All monetary amounts are stored as integer PAISE
 * (1 rupee = 100 paise) to avoid floating-point drift — the same convention
 * as the backend. Convert at the form boundary and format for display with
 * these helpers.
 *
 * Ported verbatim from the web app (src/lib/money.ts).
 */
